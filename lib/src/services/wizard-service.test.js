(function () {
  ...
  describe('wizardService', function () {
    var wizardService, $rootScope, mock$state;
    ...
    describe('when calling getStepClass(step, currentMajorStep, currentStep)', function() {
      ...
      describe('where wizard step is NOT disabled '+
               'and the wizard step has substeps and the current major step '+
               'and current step are the same as the wizard step', function() {
        var step = {
          disabled: false,
          steps: [
      ...
      describe('where wizard step is disabled '+
               'and the wizard step has substeps and the current major step '+
               'and current step are the same as the wizard step', function() {
        var step = {
          disabled: true,
      ...
      describe('where the wizard step is the child of the current major step and '+
               'the current step is the same as the wizard step', function() {
      ...
      describe('where the wizard step is the child of the current major step and '+
               'the current step is NOT the same as the wizard step', function() {
        var currentMajorStep = {
          name: 'boom Parent',
          id: 'yodle',
          steps: [
