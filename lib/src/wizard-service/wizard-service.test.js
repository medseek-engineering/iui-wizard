(function () {
  ...
  describe('wizardService', function () {
    ...
    describe('when calling getStepClass(step, currentMajorStep, currentStep)', function() {
      describe('where step={completed: true}; currentMajorStep = step; currentStep = step', function() {
        var step = {
          completed: true
        };
      ...
      describe('where step={completed: false}; currentMajorStep = step; currentStep = step', function() {
        var step = {
          completed: false
        };
        var currentMajorStep = step;
      ...
      describe('where step={isOpen: true}; currentMajorStep = step; currentStep = step', function() {
        var step = {
          isOpen: true
        };
        var currentMajorStep = step;
      ...
      describe('where step={isOpen: false}; currentMajorStep = step; currentStep = step', function() {
        var step = {
          isOpen: false
        };
        var currentMajorStep = step;
      ...
      describe('where step={disabled: true}; currentMajorStep = step; currentStep = step', function() {
        var step = {
          disabled: true
        };
        var currentMajorStep = step;
      ...
      describe('where step={disabled: false}; currentMajorStep = step; currentStep = step', function() {
        var step = {
          disabled: false
        };
        var currentMajorStep = step;
